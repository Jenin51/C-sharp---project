...
{
    public partial class jakaria_guest : Form
    {
        public jakaria_guest()
        {
            InitializeComponent();
        }

        private void jakaria_guest_Load(object sender, EventArgs e)
        {
        }
        ...
        private void save_button_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    {
                        using (SqlCommand cmd = new SqlCommand("INSERT INTO jakaria_guest_table values (@name, @age, @relationship, @gender, @date, @time, @nid, @phone, @address)", con))
                        {
                            con.Open();
