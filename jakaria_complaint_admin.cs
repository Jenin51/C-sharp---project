...
{
    public partial class jakaria_complaint_admin : Form
    {
        private SqlConnection con;
        public jakaria_complaint_admin()
        {
            InitializeComponent();
        ...
        private void jakaria_complaint_admin_Load(object sender, EventArgs e)
        {
        ...
        private void Send_notice_button_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("INSERT INTO jakaria_complaint_admin_table values (@notice, @date)", con);
