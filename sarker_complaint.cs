...
{
    public partial class sarker_complaint : Form
    {
        public sarker_complaint()
        {
            InitializeComponent();
        }
        ...
        {
            string subject = guna2TextBox1.Text;
            string complaint = guna2TextBox2.Text;
            ...
            try {
                ...
                con.Open();
                SqlCommand cmd = new SqlCommand("INSERT INTO sarker_complaint values (@subject, @complaint)", con);
        ...
        private void sarker_complaint_Load(object sender, EventArgs e)
        {
