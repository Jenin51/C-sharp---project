...
{
    public partial class pramanik_guest : Form
    {
        public pramanik_guest()
        {
            InitializeComponent();
        }
        ...
        private void save_button_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    {
                        using (SqlCommand cmd = new SqlCommand("INSERT INTO pramanik_guest_table values (@name, @age, @relationship, @gender, @date, @time, @nid, @phone, @address)", con))
                        {
                            con.Open();
        ...
        {
            pramanik c = new pramanik();
            c.Show();
                this.Hide();
        }

        private void pramanik_guest_Load(object sender, EventArgs e)
        {
